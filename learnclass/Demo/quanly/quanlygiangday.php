         ...
         // Hàm lấy dữ liệu từ CSDL và hiển thị
            ...
            // Hàm Delete bản ghi
             ...
             if ($cmd == 'Thêm') { // Nếu click nút Xoa
                 if($giangvien!= null && $monhoc!=null && $ngaybatdau!=null){
				 insertData($giangvien,$monhoc,$ngaybatdau);
				  getData();
				 }else{
					 echo "Hãy nhập đủ";
				 }// Thêm bản ghi vào bảng hoivien
                 // Gọi lại hàm để lấy dữ liệu và hiển thị sau khi thêm bản ghi
             } else if ($cmd == 'Xóa') { 
             // Nếu click nút Xóa
