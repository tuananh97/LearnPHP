   ...
   <head>
    ...
    function getData()
    {
        ...
        for ($i = 0; $i < $numrows; $i ++) {
         ...
         <td>" . (($ketqua[$i]['gioitinh'] == 1) ? "Nam" : "Nu") . "</td></tr>
         ";
        }
    }
    getData();
    ...
    if ($cmd == 'Cap nhat') { // Nếu click nút Cap nhat
         ...
         <tr>
            <td>
               <table align="center">
                  ...
                  <tr align="center">
                     <td colspan="2">
                        <input type="submit" value="Xoa" name="cmd" />
                        <input type="submit" value="Cap nhat" name="cmd" />
