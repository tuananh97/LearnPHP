...
// getting users form the table 
	...
	echo "<table width='800' border='1' bgcolor='orange'>
			<tr align='center'>
				<th>User No:</th>
				<th>User Name:</th>
				<th>User Email:</th>
	...
	$sel_users = "select * from new_user order by 1 DESC";
...
//deleting a user from the table 
	...
	if(isset($_GET['del'])){
		...
		$delete_user = "delete from new_user where user_id='$del_id'";
...
//creating mysqli query 
	 ...
	 $query = "insert into new_users (user_name,user_email,user_pass) values ('$user_name','$user_email','$user_pass')";
...
//Updating data code
	if(isset($_POST['update']))
	{
		$update_id = $user_id;
			...
			$update_users = "update new_user set user_name='$name', user_email='$email', user_password='$pass' where user_id='$update_id'";
