...
// getting users form the table
	...
	";
	$sel_users = "select * from new_users order by user_name ";
...
//creating mysqli query
	 ...
	 $query = "insert into new_users(user_name,user_email,user_password) 
...
//Updating data code
	if(isset($_POST['update']))
	{
		$update_id = $user_id;
			...
			$update_users = "update new_users set user_name='$name', user_email='$email', user_password='$pass' where user_id='$update_id'";
